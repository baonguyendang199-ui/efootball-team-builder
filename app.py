    ...
    if current_tab == 'overview':
        ...
        st.dataframe(
            ...
            column_config={
                ...
                "Player": st.column_config.TextColumn("Player", width="medium", help="Tên cầu thủ"),
                ...
                "Position Style": st.column_config.TextColumn("Position Style", width="medium", help="Phong cách"),
